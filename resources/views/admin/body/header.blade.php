...
<header>
    <div class="topbar d-flex align-items-center">
        <nav class="navbar navbar-expand">
            ...
            <div class="user-box dropdown mt-2">
                ...
                <ul class="dropdown-menu dropdown-menu-end " style="margin-top: 200px">
                    <li><a class="dropdown-item" href="{{ route('admin.profile') }}"><i class="bx bx-user"></i><span>Профиль</span></a> </li>
                    <li><a class="dropdown-item" href="{{ route('admin.change.password') }}"><i class="bx bx-cog"></i><span>Пароль</span></a> </li>
                    <li> <div class="dropdown-divider mb-0"></div> </li>
                    <li><a class="dropdown-item" href="{{ route('admin.logout') }}"><i class='bx bx-log-out-circle'></i><span>Выход</span></a></li>
                </ul>
            </div>
        </nav>
    </div>
