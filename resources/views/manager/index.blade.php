...
<div class="page-content">
	...
	@if($status === 'active')
	<h4>Менеджер аккаунта  <span class="text-success">Активен !</span> </h4>
	@else
	<h4>Менеджер аккаунта <span class="text-danger">Не Активен !</span> </h4>
	<p class="text-danger"><b> Пожалуйста, подождите, администратор проверит и одобрит ваш аккаунт</b></p>
	@endif
